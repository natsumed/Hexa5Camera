...
#include "../../../../../JoystickIdentifier/VideoReceiver/VideoReceiver.h"
...
void VideoReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (VideoReceiver::*)();
            if (_q_method_type _q_method = &VideoReceiver::cameraStarted; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_q_method_type _q_method = &VideoReceiver::cameraError; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
